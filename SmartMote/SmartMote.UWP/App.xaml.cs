...
namespace SmartMote.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            Color darkBackgroundColor = (Color)Current.Resources["PrimaryColor"];
            Color backgroundColor = (Color)Current.Resources["PrimaryDarkColor"];
            Color accentColor = (Color)Current.Resources["SystemAccentColor"];
